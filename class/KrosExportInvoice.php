...
class KrosExportInvoice{
    ...
    public function generate($data=array()){
        ...
        $invoice_header = array(
            ...
            ($data["name"]!="")?$data["name"]:'',
            ($data["ico"]!="")?$data["ico"]:'',
            ($data["date_issue"]!="")?date('d.m.Y',strtotime($data["date_issue"])):date('d.m.Y'),
            ($data["date_due"]!="")?date('d.m.Y',strtotime($data["date_due"])):date('d.m.Y'),
            ($data["duzp"]!="")?date('d.m.Y',strtotime($data["duzp"])):date('d.m.Y'),
